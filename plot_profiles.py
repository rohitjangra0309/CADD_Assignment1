...
e = modeller.Environ()
a = modeller.Alignment(e, file='queryResult.ali')

template = get_profile('6zb4.profile', a['6zb4A'])
model = get_profile('E484K.B99990010.profile', a['E484K'])
...
pylab.legend()
pylab.savefig('dope_profile9.png', dpi=65)
